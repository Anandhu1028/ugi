            ...
            <div className="evd-meta">
              ...
              <div className="evd-meta-item">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                  ...
                  <path d="M8 1C5.2 1 2 3.3 2 7c0 5 6 9 6 9s6-4 6-9c0-3.7-3.2-6-6-6z" stroke="currentColor" strokeWidth="1.4"/>
                </svg>
            ...
            <main className="evd-main">
              ...
              <div className="evd-section">
                ...
                {event.longDescription.map((para, i) => (
                  <p key={i} className="evd-paragraph">{para}</p>
                ))}
              </div>
                      ...
                      <div className="evd-gallery-hover">
                        <div className="evd-zoom-btn">
                          <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                            ...
                            <path d="M21 21l-4.35-4.35M11 8v6M8 11h6" stroke="white" strokeWidth="1.8" strokeLinecap="round"/>
                          </svg>
                        </div>
                      </div>
                    </div>
            ...
            <aside className="evd-sidebar">
              ...
              <div className="evd-sidebar-card">
                ...
                <div className="evd-info-list">
                  {[
                    { icon: "📅", label: "Date",         value: event.details.eventDate },
                    { icon: "📍", label: "Location",     value: event.details.eventPlace },
                    { icon: "🏢", label: "Organised By", value: event.details.eventBy },
                  ].map((item) => (
              ...
              <div className="evd-sidebar-card">
                ...
                <div className="evd-share">
                  {[
                    ...
                    <a key={s.name} href="#" className="evd-share-btn" style={{ background: s.color }} aria-label={s.name}>

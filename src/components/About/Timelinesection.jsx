...
const timelineData = [
  {
    year: "2017",
    label: "Founded UGI in Dubai",
    desc: "Laid the cornerstone of a unified business ecosystem with a bold vision spanning multiple industries and global ambitions.",
  },
  {
    year: "2017",
    label: "Established Moto Factory in Kerala",
    desc: "Launched our automotive vertical, bringing world-class vehicle solutions and services to Southern India.",
  },
  {
    year: "2018",
    label: "Established Focuz Academy in Kerala",
    desc: "Invested in the next generation through professional skill-development and education programs across disciplines.",
  },
  {
    year: "2019",
    label: "Le Orenda, Wishtree & Cyberwoodz",
    desc: "Expanded into luxury gifting, IT consultancy in Dubai, and cutting-edge software development in Kerala.",
  },
  {
    year: "2020",
    label: "Inception of Tecswam",
    desc: "Launched our flagship technology arm across Dubai & Kerala, scaling digital transformation services globally.",
  },
  {
    year: "2022",
    label: "Established RiverWoodz in Kerala",
    desc: "Entered the premium tourism and hospitality space with a celebrated riverside lifestyle destination.",
  },
  {
    year: "Soon",
    label: "Dreamzone · Scholium · Cafe 33",
    desc: "Our next chapter — creative education, academic consulting in Dubai, and a signature café lifestyle experience.",
    upcoming: true,
  },
];
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        ctx.beginPath();
        ctx.moveTo(off - H * 0.6, 0);
        ctx.lineTo(off, H * 0.6);
        ctx.stroke();
      }
    ...
    <section style={S.section}>
      ...
      <div style={S.container}>
        ...
        >
          ...
          <h2 style={S.title}>
            Milestones That <span style={S.titleAccent}>Define Us</span>
          </h2>
          <p style={S.subtitle}>
            From a single idea in Dubai to a global multi-industry ecosystem —
            <br />
            every year marks a new chapter of relentless growth.
          </p>
          ...
          {[
            ...
            >
              <span style={S.statNum}>
                <AnimCounter target={n} suffix={s} inView={statInView} />
              </span>
...
function TimelineRow({ item, index }) {
  ...
  return (
    ...
    >
      {/* ── Card ── */}
      <div
        style={{ ...S.half, alignItems: isLeft ? "flex-end" : "flex-start" }}
      >
        <div
        ...
        >
          ...
          {/* year chip */}
          <div style={{ ...S.chip, ...(item.upcoming && S.chipDim) }}>
            {item.year}
          </div>
          ...
          <h3
            style={{
              ...S.cardTitle,
              color: item.upcoming ? "rgba(212,175,55,0.5)" : "#fff",
            }}
          >
            {item.label}
          </h3>
...
const S = {
  ...
  vignette: {
    ...
    pointerEvents: "none",
    background:
      "radial-gradient(ellipse 80% 55% at 50% 50%, transparent 25%, rgba(6,6,15,0.72) 100%)",
  },
  container: {
    position: "relative",
    zIndex: 2,
  ...
  stat: {
    ...
    padding: "32px 16px",
    background:
      "linear-gradient(160deg, rgba(255,255,255,0.028), rgba(255,255,255,0.008))",
  ...
  card: {
    ...
    width: "100%",
    background:
      "linear-gradient(150deg, rgba(18,18,28,0.92) 0%, rgba(12,12,20,0.96) 100%)",
    border: "1px solid",
    borderRadius: 20,
    padding: "38px 40px",
    position: "relative",

  ...
  const frameId = requestAnimationFrame(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.timeline({ delay: 0.25 })
        ...
        .from(".about-hero-title", { y: 55, opacity: 0, duration: 1.1 }, "-=0.5")
        .from(".about-hero-sub", { y: 28, opacity: 0, duration: 0.9 }, "-=0.65")
        .from(".about-hero-ornament", { scaleX: 0, opacity: 0, duration: 0.7 }, "-=0.5")
        .from(".about-hero-corner", { scale: 0, opacity: 0, stagger: 0.15 }, "-=0.5")
...
/* Split panels */
splitTl.to(".about-banner-left", {
  xPercent: -100,
  ease: "power3.inOut"
}, 0);

splitTl.to(".about-banner-right", {
  xPercent: 100,
  ease: "power3.inOut"
}, 0);

/* Fade banner content */
splitTl.to(".about-banner-content", {
  opacity: 0,
  scale: 0.95,
}, 0);

/* Vision zooms IN from inside split */
splitTl.to(visionRef.current, {
  scale: 1,
  opacity: 1,
  ease: "power3.out"
}, 0.15);
